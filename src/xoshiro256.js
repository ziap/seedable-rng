 ...
 *
 * I implement `Xoshiro256+` instead of `Xoshiro256**` because it's faster and
 * the bad low bits are discarded when converting to floating point anyways.
 *
...
export default function Xoshiro256(seed) {
  ...
  if (seed) {
    ...
    // TODO: Switch to Murmur3, somehow directly hash the seed to 256 bit
